...
To use these stylesheets, rename the files and subomega with the name of your theme.
...
subomega-alpha-default-narrow.css  
...
subomega-alpha-default-normal.css
...
subomega-alpha-default-wide.css
